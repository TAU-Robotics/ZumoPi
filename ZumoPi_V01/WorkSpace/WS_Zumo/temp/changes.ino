...
void loop() {
  ...
  if (millis() - msg_time > MSG_TIMEOUT_MILLIS)
  {
    communication_timed_out = 1;
    // stop all
  }
  ...
  if (stringComplete) 
  {
    ...
    str = inputString.substring(0, ind0);   // capture first data String - auto_mode flag 
    auto_mode = str.toInt();
